...
class Bus
  ...
  def self.grab_object()
    category=get_category(rand(2..16).to_s).capitalize.constantize
    node_number=1
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test3()
  #   category=get_category(3.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test4()
  #   category=get_category(4.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test5()
  #   category=get_category(5.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test6()
  #   category=get_category(6.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test7()
  #   category=get_category(7.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test8()
  #   category=get_category(8.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test9()
  #   category=get_category(9.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test10()
  #   category=get_category(10.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test11()
  #   category=get_category(11.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test12()
  #   category=get_category(12.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test13()
  #   category=get_category(13.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test14()
  #   category=get_category(14.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test15()
  #   category=get_category(15.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
  ...
  #   return [category.find_by_node_number(node_number)[:answer_or_question], category.to_s, node_number] #return array
  # end
  # def self.grab_object_test16()
  #   category=get_category(16.to_s).capitalize.constantize
  #   node_number=1
  #
  #   while(category.find_by_node_number(node_number)[:what_am_i]!="Answer")
  #     node_number=(node_number*2)+rand(0..1)
